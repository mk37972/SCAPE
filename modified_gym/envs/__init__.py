from modified_gym.envs.registration import registry, register, make, spec
...
for reward_type in ['sparse', 'dense']:
    ...
    register(
        id='Block{}-v1'.format(suffix),
        entry_point='modified_gym.envs.robotics:BlockEnv',
        kwargs=kwargs,
        max_episode_steps=50,
    )

    register(
        id='Chip{}-v1'.format(suffix),
        entry_point='modified_gym.envs.robotics:ChipEnv',
        kwargs=kwargs,
        max_episode_steps=50,
    )

    register(
        id='NuFingers{}-v1'.format(suffix),
        entry_point='modified_gym.envs.robotics:NuFingersEnv',
        kwargs=kwargs,
        max_episode_steps=75,
    )

    register(
        id='Block{}-v2'.format(suffix),
        entry_point='modified_gym.envs.robotics:BlockEnvIL',
        kwargs=kwargs,
        max_episode_steps=50,
    )

    register(
        id='Chip{}-v2'.format(suffix),
        entry_point='modified_gym.envs.robotics:ChipEnvIL',
        kwargs=kwargs,
        max_episode_steps=50,
    )
    register(
        id='NuFingers{}-v2'.format(suffix),
        entry_point='modified_gym.envs.robotics:NuFingersEnvIL',
        kwargs=kwargs,
        max_episode_steps=75,
    )
